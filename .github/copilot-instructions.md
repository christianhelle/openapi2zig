...
Install Zig 0.15.2 exactly (other versions will NOT work):

**Option 1: GitHub Codespaces (RECOMMENDED for development)**
```bash
# Navigate to repository on GitHub → Code → Codespaces → Create codespace
# Everything is pre-configured with Zig 0.15.2, takes 2-3 minutes to set up
```
...
# Uses .devcontainer/devcontainer.json with Zig 0.15.2
```

**Option 3: Manual Installation**
```bash
# Download Zig 0.15.2 from https://ziglang.org/download/0.15.2/
# Linux x86_64:
...
# Verify installation
zig version  # Must output "0.15.2"
```
...
### Installation Issues
- **"zig: command not found"**: Install Zig 0.15.2 exactly using methods above
- **Wrong Zig version**: Uninstall other versions, install 0.15.2 specifically  
- **Build failures**: Ensure you're using Zig 0.15.2, not 0.13.x or 0.15.x
