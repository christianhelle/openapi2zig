// <auto-generated>
//   This code was generated by openapi2zig 0.5.6 (46fe56b) on 2026-09-07 09:00:35 UTC
//   Changes to this file may cause incorrect behavior and will be lost if the code is regenerated
//   Checksum: 4aa4f139ccda00cb
// </auto-generated>
...
pub const AddPet = struct {
    ...
    pub fn execute(self: *AddPet, requestBody: Pet) !Owned(Pet) {
        return addPet(self.client, requestBody);
    }

    pub fn executeRaw(self: *AddPet, requestBody: Pet) !RawResponse {
...
pub const UpdatePet = struct {
    ...
    pub fn execute(self: *UpdatePet, requestBody: Pet) !Owned(Pet) {
        return updatePet(self.client, requestBody);
    }

    pub fn executeRaw(self: *UpdatePet, requestBody: Pet) !RawResponse {
...
pub const GetPetById = struct {
    ...
    pub fn execute(self: *GetPetById, petId: i64) !Owned(Pet) {
...
pub const UploadFile = struct {
    ...
    pub fn execute(self: *UploadFile, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !Owned(ApiResponse) {
...
pub const PlaceOrder = struct {
    ...
    pub fn execute(self: *PlaceOrder, requestBody: Order) !Owned(Order) {
        return placeOrder(self.client, requestBody);
    }

    pub fn executeRaw(self: *PlaceOrder, requestBody: Order) !RawResponse {
...
pub const GetOrderById = struct {
    ...
    pub fn execute(self: *GetOrderById, orderId: i64) !Owned(Order) {
...
pub const CreateUser = struct {
    ...
    pub fn execute(self: *CreateUser, requestBody: User) !void {
...
pub const CreateUsersWithListInput = struct {
    ...
    pub fn execute(self: *CreateUsersWithListInput, requestBody: []const std.json.Value) !Owned(User) {
...
pub const GetUserByName = struct {
    ...
    pub fn execute(self: *GetUserByName, username: []const u8) !Owned(User) {
...
pub const UpdateUser = struct {
    ...
    pub fn execute(self: *UpdateUser, username: []const u8, requestBody: User) !void {
