...
//   Checksum: ea100f40c3c2acf0
// </auto-generated>

const std = @import("std");
const types = @import("types.zig");
const http = @import("http.zig");
const Owned = http.Owned;
const HttpObserver = http.HttpObserver;
const RawResponse = http.RawResponse;
const ParseErrorResponse = http.ParseErrorResponse;
const ApiResult = http.ApiResult;
const CancellationToken = http.CancellationToken;
const checkCancellation = http.checkCancellation;
const CancelableReader = http.CancelableReader;
const parseSseReader = http.parseSseReader;
const parseSseBytes = http.parseSseBytes;
const parseSseBytesTyped = http.parseSseBytesTyped;
const parseSseReaderTyped = http.parseSseReaderTyped;
const TypedSseCallback = http.TypedSseCallback;
...
//
pub fn listModels(client: *Client) !Owned(types.ListModelsResponse) {
...
pub fn listModelsResult(client: *Client) !ApiResult(types.ListModelsResponse) {
    return parseRawResponse(types.ListModelsResponse, try listModelsRaw(client));
}
...
//
pub fn downloadModel(client: *Client, requestBody: types.DownloadModelRequest) !Owned(types.DownloadModelResponse) {
...
pub fn downloadModelRaw(client: *Client, requestBody: types.DownloadModelRequest) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
pub fn downloadModelResult(client: *Client, requestBody: types.DownloadModelRequest) !ApiResult(types.DownloadModelResponse) {
    return parseRawResponse(types.DownloadModelResponse, try downloadModelRaw(client, requestBody));
}
...
//
pub fn getDownloadStatus(client: *Client, job_id: []const u8) !Owned(types.DownloadStatusResponse) {
...
pub fn getDownloadStatusRaw(client: *Client, job_id: []const u8) !RawResponse {
    ...
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
    try uri_buf.writer.print("{s}/api/v1/models/download/status/{f}", .{ client.base_url, pathComponent(job_id) });
    const payload: ?[]const u8 = null;
...
pub fn getDownloadStatusResult(client: *Client, job_id: []const u8) !ApiResult(types.DownloadStatusResponse) {
    return parseRawResponse(types.DownloadStatusResponse, try getDownloadStatusRaw(client, job_id));
}
...
//
pub fn unloadModel(client: *Client, requestBody: types.UnloadModelRequest) !Owned(types.UnloadModelResponse) {
...
pub fn unloadModelRaw(client: *Client, requestBody: types.UnloadModelRequest) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
pub fn unloadModelResult(client: *Client, requestBody: types.UnloadModelRequest) !ApiResult(types.UnloadModelResponse) {
    return parseRawResponse(types.UnloadModelResponse, try unloadModelRaw(client, requestBody));
}
...
//
pub fn loadModel(client: *Client, requestBody: types.LoadModelRequest) !Owned(types.LoadModelResponse) {
...
pub fn loadModelRaw(client: *Client, requestBody: types.LoadModelRequest) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
pub fn loadModelResult(client: *Client, requestBody: types.LoadModelRequest) !ApiResult(types.LoadModelResponse) {
    return parseRawResponse(types.LoadModelResponse, try loadModelRaw(client, requestBody));
}
...
//
pub fn chat(client: *Client, requestBody: types.ChatRequest) !Owned(types.ChatResponse) {
...
pub fn chatRaw(client: *Client, requestBody: types.ChatRequest) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
pub fn chatResult(client: *Client, requestBody: types.ChatRequest) !ApiResult(types.ChatResponse) {
    return parseRawResponse(types.ChatResponse, try chatRaw(client, requestBody));
}
...
pub const resources = struct {
    pub const api = struct {
        pub const chat = struct {
            pub fn chat_(client: *Client, requestBody: types.ChatRequest) !Owned(types.ChatResponse) {
                return _chat(client, requestBody);
            }
            pub fn chat_Result(client: *Client, requestBody: types.ChatRequest) !ApiResult(types.ChatResponse) {
        ...
        pub const models = struct {
            pub fn list(client: *Client) !Owned(types.ListModelsResponse) {
                return listModels(client);
            }
            pub fn listResult(client: *Client) !ApiResult(types.ListModelsResponse) {
            ...
            pub const download = struct {
                ...
                pub const status = struct {
                    pub fn get(client: *Client, job_id: []const u8) !Owned(types.DownloadStatusResponse) {
                        return getDownloadStatus(client, job_id);
                    }
                    pub fn getResult(client: *Client, job_id: []const u8) !ApiResult(types.DownloadStatusResponse) {
