...
pub fn main(init: std.process.Init) !void {
    ...
    client.http_observer = http.HttpObserver{
        .ctx = null,
    ...
    var cancel_token = http.CancellationToken.init();
    const cancel_thread = try std.Thread.spawn(.{}, struct {
        fn run(cancellation_token: *http.CancellationToken, thread_io: std.Io) !void {
