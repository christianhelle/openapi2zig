...
pub const PetClient = struct {
    ...
    pub fn addPet(self: *PetClient, requestBody: models.Pet) !Owned(models.Pet) {
        return _addPet(self.client, requestBody);
    }

    pub fn addPetRaw(self: *PetClient, requestBody: models.Pet) !RawResponse {
        return _addPetRaw(self.client, requestBody);
    }

    pub fn addPetResult(self: *PetClient, requestBody: models.Pet) !ApiResult(models.Pet) {
        return _addPetResult(self.client, requestBody);
    }

    pub fn updatePet(self: *PetClient, requestBody: models.Pet) !Owned(models.Pet) {
        return _updatePet(self.client, requestBody);
    }

    pub fn updatePetRaw(self: *PetClient, requestBody: models.Pet) !RawResponse {
        return _updatePetRaw(self.client, requestBody);
    }

    pub fn updatePetResult(self: *PetClient, requestBody: models.Pet) !ApiResult(models.Pet) {
    ...
    pub fn getPetById(self: *PetClient, petId: i64) !Owned(models.Pet) {
    ...
    pub fn getPetByIdResult(self: *PetClient, petId: i64) !ApiResult(models.Pet) {
    ...
    pub fn uploadFile(self: *PetClient, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !Owned(models.ApiResponse) {
...
pub const StoreClient = struct {
    ...
    pub fn placeOrder(self: *StoreClient, requestBody: models.Order) !Owned(models.Order) {
        return _placeOrder(self.client, requestBody);
    }

    pub fn placeOrderRaw(self: *StoreClient, requestBody: models.Order) !RawResponse {
        return _placeOrderRaw(self.client, requestBody);
    }

    pub fn placeOrderResult(self: *StoreClient, requestBody: models.Order) !ApiResult(models.Order) {
    ...
    pub fn getOrderById(self: *StoreClient, orderId: i64) !Owned(models.Order) {
...
pub const UserClient = struct {
    ...
    pub fn createUser(self: *UserClient, requestBody: models.User) !void {
        return _createUser(self.client, requestBody);
    }

    pub fn createUserRaw(self: *UserClient, requestBody: models.User) !RawResponse {
        return _createUserRaw(self.client, requestBody);
    }

    pub fn createUsersWithListInput(self: *UserClient, requestBody: []const std.json.Value) !Owned(models.User) {
    ...
    pub fn createUsersWithListInputResult(self: *UserClient, requestBody: []const std.json.Value) !ApiResult(models.User) {
    ...
    pub fn getUserByName(self: *UserClient, username: []const u8) !Owned(models.User) {
    ...
    pub fn getUserByNameResult(self: *UserClient, username: []const u8) !ApiResult(models.User) {
        return _getUserByNameResult(self.client, username);
    }

    pub fn updateUser(self: *UserClient, username: []const u8, requestBody: models.User) !void {
