// <auto-generated>
//   This code was generated by openapi2zig 0.5.0 (7e794c1) on 2026-08-29 16:44:52 UTC
//   Changes to this file may cause incorrect behavior and will be lost if the code is regenerated
//   Checksum: 82c2632a53d641
// </auto-generated>
...
fn appendClientHeaders(allocator: std.mem.Allocator, headers: *std.ArrayList(std.http.Header), client: *Client, content_type: ?[]const u8, accept: []const u8) !?[]u8 {
    ...
    if (client.api_key.len > 0) {
        try headers.append(allocator, .{ .name = "api_key", .value = client.api_key });
    }
...
pub fn uploadFileRaw(client: *Client, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !RawResponse {
    ...
    const auth_header = try appendClientHeaders(allocator, &operation_headers, client, "application/octet-stream", "application/json");
    defer if (auth_header) |value| allocator.free(value);
