...
const per_endpoint_models = @import("per_endpoint_models.zig");
const per_endpoint_runtime = @import("per_endpoint_runtime.zig");
const Owned = per_endpoint_runtime.Owned;
const HttpObserver = per_endpoint_runtime.HttpObserver;
const RawResponse = per_endpoint_runtime.RawResponse;
const ParseErrorResponse = per_endpoint_runtime.ParseErrorResponse;
const ApiResult = per_endpoint_runtime.ApiResult;
const CancellationToken = per_endpoint_runtime.CancellationToken;
const checkCancellation = per_endpoint_runtime.checkCancellation;
const parseSseReader = per_endpoint_runtime.parseSseReader;
const parseSseBytes = per_endpoint_runtime.parseSseBytes;
const parseSseBytesTyped = per_endpoint_runtime.parseSseBytesTyped;
const parseSseReaderTyped = per_endpoint_runtime.parseSseReaderTyped;
const TypedSseCallback = per_endpoint_runtime.TypedSseCallback;
...
//
pub fn placeOrder(client: *Client, requestBody: per_endpoint_models.Order) !Owned(per_endpoint_models.Order) {
...
pub fn placeOrderRaw(client: *Client, requestBody: per_endpoint_models.Order) !RawResponse {
    const allocator = client.allocator;
...
pub fn placeOrderResult(client: *Client, requestBody: per_endpoint_models.Order) !ApiResult(per_endpoint_models.Order) {
    return parseRawResponse(per_endpoint_models.Order, try placeOrderRaw(client, requestBody));
}
...
// 
//
pub fn uploadFile(client: *Client, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !Owned(per_endpoint_models.ApiResponse) {
...
pub fn uploadFileResult(client: *Client, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !ApiResult(per_endpoint_models.ApiResponse) {
    return parseRawResponse(per_endpoint_models.ApiResponse, try uploadFileRaw(client, petId, additionalMetadata, requestBody));
}
...
//
pub fn getPetById(client: *Client, petId: i64) !Owned(per_endpoint_models.Pet) {
...
pub fn getPetByIdResult(client: *Client, petId: i64) !ApiResult(per_endpoint_models.Pet) {
    return parseRawResponse(per_endpoint_models.Pet, try getPetByIdRaw(client, petId));
}
...
// 
//
pub fn getUserByName(client: *Client, username: []const u8) !Owned(per_endpoint_models.User) {
...
pub fn getUserByNameResult(client: *Client, username: []const u8) !ApiResult(per_endpoint_models.User) {
    return parseRawResponse(per_endpoint_models.User, try getUserByNameRaw(client, username));
}
...
//
pub fn updateUser(client: *Client, username: []const u8, requestBody: per_endpoint_models.User) !void {
    var raw = try updateUserRaw(client, username, requestBody);
    defer raw.deinit();
    if (raw.status.class() != .success) return error.ResponseError;
}

pub fn updateUserRaw(client: *Client, username: []const u8, requestBody: per_endpoint_models.User) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
    try uri_buf.writer.print("{s}/user/{s}", .{client.base_url, username});
...
// This can only be done by the logged in user.
//
pub fn createUser(client: *Client, requestBody: per_endpoint_models.User) !void {
    var raw = try createUserRaw(client, requestBody);
    defer raw.deinit();
    if (raw.status.class() != .success) return error.ResponseError;
}

pub fn createUserRaw(client: *Client, requestBody: per_endpoint_models.User) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
// Creates list of users with given input array
//
pub fn createUsersWithListInput(client: *Client, requestBody: []const std.json.Value) !Owned(per_endpoint_models.User) {
...
pub fn createUsersWithListInputResult(client: *Client, requestBody: []const std.json.Value) !ApiResult(per_endpoint_models.User) {
    return parseRawResponse(per_endpoint_models.User, try createUsersWithListInputRaw(client, requestBody));
}
...
// Add a new pet to the store
//
pub fn addPet(client: *Client, requestBody: per_endpoint_models.Pet) !Owned(per_endpoint_models.Pet) {
...
pub fn addPetRaw(client: *Client, requestBody: per_endpoint_models.Pet) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
...
pub fn addPetResult(client: *Client, requestBody: per_endpoint_models.Pet) !ApiResult(per_endpoint_models.Pet) {
    return parseRawResponse(per_endpoint_models.Pet, try addPetRaw(client, requestBody));
}
...
//
pub fn updatePet(client: *Client, requestBody: per_endpoint_models.Pet) !Owned(per_endpoint_models.Pet) {
...
pub fn updatePetRaw(client: *Client, requestBody: per_endpoint_models.Pet) !RawResponse {
    const allocator = client.allocator;
    var uri_buf: std.Io.Writer.Allocating = .init(allocator);
    defer uri_buf.deinit();
    try uri_buf.writer.print("{s}/pet", .{client.base_url});
...
pub fn updatePetResult(client: *Client, requestBody: per_endpoint_models.Pet) !ApiResult(per_endpoint_models.Pet) {
    return parseRawResponse(per_endpoint_models.Pet, try updatePetRaw(client, requestBody));
}
...
//
pub fn getOrderById(client: *Client, orderId: i64) !Owned(per_endpoint_models.Order) {
...
pub fn getOrderByIdResult(client: *Client, orderId: i64) !ApiResult(per_endpoint_models.Order) {
    return parseRawResponse(per_endpoint_models.Order, try getOrderByIdRaw(client, orderId));
}
...
pub const AddPet = struct {
    ...
    pub fn execute(self: *AddPet, requestBody: per_endpoint_models.Pet) !Owned(per_endpoint_models.Pet) {
        return addPet(self.client, requestBody);
    }

    pub fn executeRaw(self: *AddPet, requestBody: per_endpoint_models.Pet) !RawResponse {
        return addPetRaw(self.client, requestBody);
    }

    pub fn executeResult(self: *AddPet, requestBody: per_endpoint_models.Pet) !ApiResult(per_endpoint_models.Pet) {
...
pub const UpdatePet = struct {
    ...
    pub fn execute(self: *UpdatePet, requestBody: per_endpoint_models.Pet) !Owned(per_endpoint_models.Pet) {
        return updatePet(self.client, requestBody);
    }

    pub fn executeRaw(self: *UpdatePet, requestBody: per_endpoint_models.Pet) !RawResponse {
        return updatePetRaw(self.client, requestBody);
    }

    pub fn executeResult(self: *UpdatePet, requestBody: per_endpoint_models.Pet) !ApiResult(per_endpoint_models.Pet) {
...
pub const GetPetById = struct {
    ...
    pub fn execute(self: *GetPetById, petId: i64) !Owned(per_endpoint_models.Pet) {
    ...
    pub fn executeResult(self: *GetPetById, petId: i64) !ApiResult(per_endpoint_models.Pet) {
...
pub const UploadFile = struct {
    ...
    pub fn execute(self: *UploadFile, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !Owned(per_endpoint_models.ApiResponse) {
    ...
    pub fn executeResult(self: *UploadFile, petId: i64, additionalMetadata: ?[]const u8, requestBody: []const u8) !ApiResult(per_endpoint_models.ApiResponse) {
...
pub const PlaceOrder = struct {
    ...
    pub fn execute(self: *PlaceOrder, requestBody: per_endpoint_models.Order) !Owned(per_endpoint_models.Order) {
        return placeOrder(self.client, requestBody);
    }

    pub fn executeRaw(self: *PlaceOrder, requestBody: per_endpoint_models.Order) !RawResponse {
        return placeOrderRaw(self.client, requestBody);
    }

    pub fn executeResult(self: *PlaceOrder, requestBody: per_endpoint_models.Order) !ApiResult(per_endpoint_models.Order) {
...
pub const GetOrderById = struct {
    ...
    pub fn execute(self: *GetOrderById, orderId: i64) !Owned(per_endpoint_models.Order) {
    ...
    pub fn executeResult(self: *GetOrderById, orderId: i64) !ApiResult(per_endpoint_models.Order) {
...
pub const CreateUser = struct {
    ...
    pub fn execute(self: *CreateUser, requestBody: per_endpoint_models.User) !void {
        return createUser(self.client, requestBody);
    }

    pub fn executeRaw(self: *CreateUser, requestBody: per_endpoint_models.User) !RawResponse {
...
pub const CreateUsersWithListInput = struct {
    ...
    pub fn execute(self: *CreateUsersWithListInput, requestBody: []const std.json.Value) !Owned(per_endpoint_models.User) {
    ...
    pub fn executeResult(self: *CreateUsersWithListInput, requestBody: []const std.json.Value) !ApiResult(per_endpoint_models.User) {
...
pub const GetUserByName = struct {
    ...
    pub fn execute(self: *GetUserByName, username: []const u8) !Owned(per_endpoint_models.User) {
    ...
    pub fn executeResult(self: *GetUserByName, username: []const u8) !ApiResult(per_endpoint_models.User) {
...
pub const UpdateUser = struct {
    ...
    pub fn execute(self: *UpdateUser, username: []const u8, requestBody: per_endpoint_models.User) !void {
        return updateUser(self.client, username, requestBody);
    }

    pub fn executeRaw(self: *UpdateUser, username: []const u8, requestBody: per_endpoint_models.User) !RawResponse {
