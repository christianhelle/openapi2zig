...
const spec_path = "openapi/v3.0/kitchen-sink.json";

fn loadKitchenSink(allocator: std.mem.Allocator) !models.OpenApiDocument {
...
test "kitchen sink 3.0 parses every document level field" {
    ...
    try std.testing.expectEqualStrings("MIT", parsed.info.license.?.name);
...
test "kitchen sink 3.0 parses server variables" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses every path item operation" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses operation metadata" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses parameter styles and examples" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses response headers content and links" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses request body encoding" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses inline and referenced callbacks" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses every components map" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses every security scheme type" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses every oauth2 flow" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.0 parses schema keywords" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
