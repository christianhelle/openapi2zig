...
const spec_path = "openapi/v3.2/kitchen-sink.json";

fn loadKitchenSink(allocator: std.mem.Allocator) !models.OpenApi32Document {
...
test "kitchen sink 3.2 parses every document level field" {
...
test "kitchen sink 3.2 parses server variables" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses every path item operation" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses operation metadata" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses parameter styles and examples" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses response headers content and links" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses request body encoding" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses inline and referenced callbacks" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses webhooks" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses every components map" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses every security scheme type" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses every oauth2 flow" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
...
test "kitchen sink 3.2 parses schema keywords" {
    var gpa = test_utils.createTestAllocator();
    const allocator = gpa.allocator();
    var parsed = try loadKitchenSink(allocator);
    defer parsed.deinit(allocator);
